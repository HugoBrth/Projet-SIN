...
export default function Home() {
  return (
    <>
      <div className="w-full min-h-screen py-20 px-5 bg-primary-400">
        <div className="flex items-center justify-between w-full ">
          ...
          <div className="space-y-5 flex flex-col border border-black w-fit p-5 rounded-lg">
            ...
            <div className="flex items-center gap-5">
              <Button icon={{icon: FaArrowRight}} size="small">Click here !</Button>
            ...
            <div className="flex items-center gap-5">
              <Button icon={{icon: FaArrowRight}} size="large">Click here !</Button>
